...
- index-bar: 新增拖动气泡提示([pull/166](https://github.com/Tuya-Community/miniapp-smart-ui/pull/166))
...
- index-bar: 修复右侧栏拖动时定位不准、页面闪现分割线、fixed 导航闪现位移等问题([pull/166](https://github.com/Tuya-Community/miniapp-smart-ui/pull/166))
