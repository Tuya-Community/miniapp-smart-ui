...
```json
"usingComponents": {
  "smart-goodsmart-action": "@tuya-miniapp/smart-ui/goodsmart-action/index",
  "smart-goodsmart-action-icon": "@tuya-miniapp/smart-ui/goodsmart-action-icon/index",
  "smart-goodsmart-action-button": "@tuya-miniapp/smart-ui/goodsmart-action-button/index"
}
```
