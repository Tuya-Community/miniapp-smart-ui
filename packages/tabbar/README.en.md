...
| link-type `v1.10.13` | Type of link jump, optional values are `redirectTo`, [`switchTab`](https://developers.weixin.qq.com/miniprogram/dev/api/route/wx.switchTab.html), `reLaunch` | _string_           | `redirectTo`      |
