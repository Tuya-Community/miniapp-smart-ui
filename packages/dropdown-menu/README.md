...
```json
"usingComponents": {
  "smart-dropdown-menu": "@tuya-miniapp/smart-ui/dropdown-menu/index",
  "smart-dropdown-item": "@tuya-miniapp/smart-ui/dropdown-item/index"
}
```
