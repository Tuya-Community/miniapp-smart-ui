...
| -------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------ | --------------------------------------- |
| close-icon-aria-label `v2.12.1` | Accessible label for the title close icon, passed to inner `smart-icon` as `aria-label`; when omitted, the icon still has `button` role via `aria-role` so apps can add i18n when needed | _string_           | -                                       |
...
| lock-max-drag  `v2.9.0`              | Whether to lock the maximum drag height. When set to `true`, the panel height will not exceed `max-drag-height` during dragging                                                                                                                                                                                                                                                                                                                                                                                                                                      | _boolean_          | `false`                                 |
| lock-scroll `v2.9.0`       | Whether to lock background scrolling                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | _boolean_          | `true`                                  |
...
| full-cover-view `v2.11.1` | Whether to use cover-view to wrap the popup for covering native components (such as map, video). | _boolean_ | `false` |
