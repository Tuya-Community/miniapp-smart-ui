...
| lock-max-drag  `v2.8.1`              | Whether to lock the maximum drag height. When set to `true`, the panel height will not exceed `max-drag-height` during dragging                                                                                                                                                                                                                                                                                                                                                                                                                                      | _boolean_          | `false`                                 |
