...
```json
"usingComponents": {
  "smart-radio": "@tuya-miniapp/smart-ui/radio/index",
  "smart-radio-group": "@tuya-miniapp/smart-ui/radio-group/index"
}
```
...
<smart-radio-group value="{{ radio }}" bind:change="onChange">
  <smart-radio name="1">单选框 1</smart-radio>
  <smart-radio name="2">单选框 2</smart-radio>
</smart-radio-group>
```
...
```html
<smart-radio-group value="{{ radio }}" bind:change="onChange">
  <smart-radio name="1" shape="square">单选框 1</smart-radio>
  <smart-radio name="2" shape="square">单选框 2</smart-radio>
</smart-radio-group>
```
...
```html
<smart-radio-group value="{{ radio }}" bind:change="onChange">
  <smart-radio name="1" checked-color="#07c160">单选框 1</smart-radio>
  <smart-radio name="2" checked-color="#07c160">单选框 2</smart-radio>
</smart-radio-group>
```
...
```html
<smart-radio-group value="{{ radio }}" bind:change="onChange">
  <smart-radio name="1" icon-size="24px">单选框 1</smart-radio>
  <smart-radio name="2" icon-size="24px">单选框 2</smart-radio>
</smart-radio-group>
```
