...
```json
"usingComponents": {
  "smart-checkbox": "@tuya-miniapp/smart-ui/checkbox/index",
  "smart-checkbox-group": "@tuya-miniapp/smart-ui/checkbox-group/index"
}
```
...
```html
<smart-checkbox value="{{ checked }}" bind:change="onChange">复选框</smart-checkbox>
```
...
```html
<smart-checkbox disabled value="{{ checked }}" bind:change="onChange">
  复选框
</smart-checkbox>
```
...
```html
<smart-checkbox value="{{ checked }}" shape="square" bind:change="onChange">
  复选框
</smart-checkbox>
```
...
```html
<smart-checkbox value="{{ checked }}" icon-size="25px">复选框</smart-checkbox>
```
...
```html
<smart-checkbox use-icon-slot value="{{ checked }}" bind:change="onChange">
  自定义图标
...
Page({
  data: {
    checked: true,
    activeIcon: 'https://static1.tuyacn.com/static/tuya-miniapp-doc/_next/static/images/logo-small.png',
    inactiveIcon: 'https://static1.tuyacn.com/static/tuya-miniapp-doc/_next/static/images/logo-small.png',
  },
...
```html
<smart-checkbox value="{{ checked }}" label-disabled>复选框</smart-checkbox>
```
