...
| clear-icon-aria-label `v2.12.1` | Accessible label for the clear button, passed to the clear icon's `aria-label`                               | _string_            | -       |
...
| right-icon-button-aria-label `v2.12.1` | Accessible label for the right icon button, set on the icon container's `aria-label`                        | _string_            | -       |
