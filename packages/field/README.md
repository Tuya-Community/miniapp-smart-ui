...
| clear-icon-aria-label `v2.12.1` | 清除按钮的无障碍读屏文案，透传至清除图标的 `aria-label`                                                      | _string_            | -       |
...
| right-icon-button-aria-label `v2.12.1` | 右侧图标按钮的无障碍读屏文案，设置在图标容器的 `aria-label` 上                                                | _string_            | -       |
