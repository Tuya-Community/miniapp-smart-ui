...
| left-arrow-aria-label `v2.13.0` | Accessible label for the left back arrow | _string_  | -       |
...
| left-icon-aria-label `v2.13.0` | Accessible label for the left icon button | _string_  | -       |
...
| right-icon-aria-label `v2.13.0` | Accessible label for the right icon button | _string_  | -   |
...
| bind:click-left-icon `v2.0.0` | Triggered when clicking the left icon (non-return icon) | -    |
